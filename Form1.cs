...
namespace TimeSheet
{
    public partial class Form1 : Form
    {
        ...
        static string connectionString = @"Data Source=TIMESHEET.vnipipt.ru\TIMESHEET;Initial Catalog=TIMESHEET;User ID=sa;Pwd=h)SFk@j2;";
        public Form1()
        {
            InitializeComponent();
        }
                    ...
                    if (SQLDbReade.HasRows)
                    {
                        ...
                        while (SQLDbReade.Read())
                        {
                            ...
                            if (PosId.Length != 0)
                            {
                                ...
                                else if (((NomPosId == 12) || (NomPosId == 14) || (NomPosId == 28)) || (NomPosId == 29) || (NomPosId == 31) || (NomPosId == 46) || (NomPosId == 272))
                                {
                                    SQLConn.Close();
